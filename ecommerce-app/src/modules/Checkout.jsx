...
const stripePromise = loadStripe("pk_test_51NXrYAFAnF7SQyLtAeyur5XOuk2CHa0SFsmSG7Mqy4bXoS6PlQfG7kdtT2wEvXVFQFmAeQO0Xhbk2q1iXSIOVwof00O5rAO5Fe");
            ...
            <div className="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm p-3">
              ...
              <dl className="space-y-6 border-t border-gray-200 px-4 py-6 sm:px-6">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                  ...
                  <dd className="text-base font-medium text-gray-900">${total+5+5}</dd>
                </div>
              </dl>
